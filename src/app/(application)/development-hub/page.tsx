...
export default function DevelopmentHubPage() {
  const { milestonesWithSteps, developmentAreas, badges, milestoneProgress, isLoading, error } =
    useDevelopmentHub();
  ...
  return (
    <AuthenticatedRoute>
      <div className="mx-auto min-h-screen mt-10 max-w-7xl bg-background flex-col items-center">
        <MainSection>
