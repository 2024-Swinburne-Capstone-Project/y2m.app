...
```
curl "https://nubesgen.com/y2m-app.zip?iactool=TERRAFORM&region=australiaeast&application=APP_SERVICE.free&runtime=DOCKER&database=POSTGRESQL.basic&addons=key_vault&gitops=true" | tar -xzvf -
```
